    ...
    <div className="min-h-screen bg-chefini-black font-sans text-black">
      ...
      <nav className="border-b-4 border-chefini-yellow bg-black px-6 py-4 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto flex justify-between items-center relative">
          <div className="flex items-center gap-2 group cursor-pointer z-50">
            ...
            <span className="text-2xl md:text-3xl font-black tracking-tighter text-chefini-yellow">CHEFINI</span>
          </div>
            ...
            <div className="relative group perspective-1000">
              <div className="bg-black border-4 border-chefini-yellow p-4 md:p-8 shadow-brutal-lg transform transition-transform group-hover:rotate-1 duration-500 max-w-sm mx-auto md:max-w-none">
                <div className="border-b-2 border-dashed border-chefini-yellow pb-4 mb-4 flex justify-between items-center">
                  ...
                  <span className="bg-red-500 text-white text-[10px] md:text-xs px-2 py-1 font-bold border border-white transform rotate-3">SAVED FROM BIN</span>
                </div>
                ...
                <div className="space-y-3 mb-8 bg-gray-900 p-4 border-2 border-gray-800">
                  ...
                  <div className="flex items-center gap-3 text-gray-300 text-sm md:text-base">
                    ...
                    <span className="line-through text-gray-500 decoration-2">Fish Head</span>
                    <span className="text-chefini-yellow font-bold">→ Flavor Bomb</span>
                  </div>
                  <div className="flex items-center gap-3 text-gray-300 text-sm md:text-base">
                    <Check size={16} className="text-green-400 shrink-0" />
                    <span className="line-through text-gray-500 decoration-2">Lentils</span>
                    <span className="text-chefini-yellow font-bold">→ Golden Gravy</span>
                  </div>
                  <div className="flex items-center gap-3 text-gray-300 text-sm md:text-base">
                    <Check size={16} className="text-green-400 shrink-0" />
                    <span className="line-through text-gray-500 decoration-2">Spices</span>
                ...
                <div className="grid grid-cols-3 gap-2 md:gap-4 text-center pt-4 border-t-2 border-dashed border-gray-700">
                  <div>
                    <div className="text-xl md:text-2xl font-black text-white">1</div>
                    <div className="text-[8px] md:text-[10px] font-bold text-chefini-yellow uppercase">Part Saved</div>
                  </div>
                  <div>
                    <div className="text-xl md:text-2xl font-black text-white">45m</div>
                    <div className="text-[8px] md:text-[10px] font-bold text-chefini-yellow uppercase">Prep Time</div>
                  </div>
                  <div>
                    <div className="text-xl md:text-2xl font-black text-white">High</div>
                    <div className="text-[8px] md:text-[10px] font-bold text-chefini-yellow uppercase">Value</div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 gap-3">
                {benefits.map((benefit, idx) => (
                  <div key={idx} className="flex items-center gap-4 bg-white/50 p-2 border-2 border-transparent hover:border-black hover:bg-white transition-all cursor-default">
                    ...
                    <span className="text-base md:text-lg font-black text-black uppercase">{benefit}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="space-y-6 mt-8 md:mt-0">
              ...
              <div className="bg-black border-4 border-black p-6 md:p-8 shadow-brutal hover:translate-x-1 hover:translate-y-1 hover:shadow-brutal-sm transition-all transform md:translate-x-8">
                <div className="flex items-center gap-4 mb-2">
                  ...
                  <h3 className="text-2xl md:text-3xl font-black text-white">2,500kg</h3>
                </div>
      ...
      <section className="py-20 md:py-32 bg-zinc-900 border-t-4 border-black relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none">
          <div className="absolute top-10 left-10 rotate-12"><ChefHat size={80} className="text-white md:w-[120px] md:h-[120px]" /></div>
          <div className="absolute bottom-10 right-10 -rotate-12"><Wand2 size={80} className="text-white md:w-[120px] md:h-[120px]" /></div>
        </div>
